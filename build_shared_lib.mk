...
$(LOCAL_INTERMEDIATES)/%.o: %.c $(CURRENT_MK) $(LOCAL_DIR)/build.mk
...
$(LOCAL_INTERMEDIATES)/%.o: %.cpp $(CURRENT_MK) $(LOCAL_DIR)/build.mk
...
$(LOCAL_INTERMEDIATES)/%.o: INTERNAL_CXX := $(LOCAL_CXX)
$(LOCAL_INTERMEDIATES)/%.o: INTERNAL_CXXFLAGS := $(LOCAL_CXXFLAGS)
$(LOCAL_INTERMEDIATES)/%.o: %.cc $(CURRENT_MK) $(LOCAL_DIR)/build.mk
	$(call print-build-header, $(INTERNAL_TARGET_NAME), CXX $(notdir $<))
	$(MKDIR) $(dir $@)
	$(INTERNAL_CXX) -c -fPIC $(INTERNAL_CXXFLAGS) -o $@ $< -MMD
...
$(LOCAL_INTERMEDIATES)/%.o: %.s $(CURRENT_MK) $(LOCAL_DIR)/build.mk
...
$(LOCAL_TARGET): INTERNAL_CC := $(LOCAL_CC)
$(LOCAL_TARGET): INTERNAL_LDFLAGS := $(LOCAL_LDFLAGS)
$(LOCAL_TARGET): INTERNAL_OBJ := $(LOCAL_OBJ)
$(LOCAL_TARGET): $(LOCAL_OBJ) $(LOCAL_TARGET_EXPORTS) $(CURRENT_MK) $(LOCAL_DIR)/build.mk
