...
$(LOCAL_TARGET_EXPORT_DIR)/%.h: %.h $(CURRENT_MK) $(PARENT_MK) $(LOCAL_PREREQUISITES)
...
$(LOCAL_TARGET_EXPORT_DIR)/%.hpp: INTERNAL_TARGET_NAME := $(LOCAL_NAME)
$(LOCAL_TARGET_EXPORT_DIR)/%.hpp: INTERNAL_EXPORTED_DIRS := $(LOCAL_EXPORTED_DIRS)
$(LOCAL_TARGET_EXPORT_DIR)/%.hpp: INTERNAL_TARGET_EXPORT_DIR := $(LOCAL_TARGET_EXPORT_DIR)
$(LOCAL_TARGET_EXPORT_DIR)/%.hpp: %.hpp $(CURRENT_MK) $(PARENT_MK) $(LOCAL_PREREQUISITES)
