...
$(LOCAL_TARGET): INTERNAL_CFLAGS := $(LOCAL_CFLAGS)
$(LOCAL_TARGET): INTERNAL_LDFLAGS := $(LOCAL_LDFLAGS)
$(LOCAL_TARGET): INTERNAL_TARGET_NAME := $(LOCAL_NAME)
$(LOCAL_TARGET): $(LOCAL_OBJ) $(LOCAL_SHARED_LIB_PATHS) $(LOCAL_STATIC_LIB_PATHS) $(CURRENT_MK) $(LOCAL_DIR)/build.mk
	$(call print-build-header, $(INTERNAL_TARGET_NAME), LD)
	$(MKDIR) $(dir $@)
	$(INTERNAL_CC) $(INTERNAL_CFLAGS) -o $@ $(filter-out %.so %.a %.mk, $^) $(INTERNAL_LDFLAGS)
